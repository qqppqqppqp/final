    ...
    <div class="myCont right_menu">
        <div class="my_box my_like">
            ...
            <div class="my_cont_box like_cont">
                <h2>찜목록</h2>
                <p class="more_btn"><a href="/board/review/list" id="likeList1">더보기</a><i class="fas fa-chevron-right"></i></p>
                <div class="container">
...
<!-- 	                                <i class="fas fa-heart on"></i> -->
            ...
            <div class="my_cont_box">
                <h2>내 리뷰</h2>
                <p class="more_btn"><a href="/board/review/list"  id="likeList2">더보기</a><i class="fas fa-chevron-right"></i></p>
                	...
                	<div class="container my_review">
                		...
                		<div class="desc_wrap">
                			<h4>
                				...
                				<a href="/board/review/view?seq=${ BoardVO.seq }">${ BoardVO.title }</a>
                			</h4>
                			<p class="desc_wrap">
                				
                				<a href="/board/review/view?seq=${ BoardVO.seq }">${ BoardVO.content }</a>
                			</p>
                		</div>
                	</div>
                </c:forEach>
...
<!--                 </div> -->
            ...
            <div class="my_cont_box my_course">
                <h2>내 코스</h2>
                <p class="more_btn"><a href="/board/course/list" id="courseBoard">더보기</a><i class="fas fa-chevron-right"></i></p>
                <div class="container">
                    내 코스 영역
                    <ul>
                    	<c:forEach var="course" items="${__COURSE__}">
	                  		...
	                  		<a id="MyCourse" href="/board/course/get?seq=${course.seq}"><li>${course.TITLE}</li></a>
