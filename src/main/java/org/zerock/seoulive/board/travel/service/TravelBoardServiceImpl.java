...
public class TravelBoardServiceImpl
    ...
    @Override
    public List<TravelBoardVO> getList(Criteria cri) throws ServiceException {
        log.trace("\n\t getList() invoked.");
    ...
    @Override
    public Boolean register(TravelBoardDTO dto) throws ServiceException {
        return null;
    }

    @Override
    public TravelBoardVO get(Integer seq) throws ServiceException {
        return null;
    }

    @Override
    public Boolean modify(TravelBoardDTO dto) throws ServiceException {
        return null;
    }
    ...
    @Override
    public List<TravelBoardVO> getListByDate(String selectedDate) {
