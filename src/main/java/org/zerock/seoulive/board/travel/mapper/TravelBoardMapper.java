...
//         FROM TBL_TRAVEL
//         """)
	public abstract List<TravelBoardVO> selectList(Criteria cri);


	// 2. 새로운 게시물 등록
	public abstract Integer insert(TravelBoardDTO dto);

	// 3. 특정 게시물 상세조회
	public abstract TravelBoardVO select(NUMBER seq);

	// 4. 특정 게시물 삭제
	public abstract Integer delete(NUMBER seq);

	// 5. 특정 게시물 업데이트(갱신)
	public abstract Integer update(TravelBoardDTO dto);
	...
	List<TravelBoardVO> selectListByDate(String selectedDate);
} // end class
