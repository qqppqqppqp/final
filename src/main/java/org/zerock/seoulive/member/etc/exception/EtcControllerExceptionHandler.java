package org.zerock.seoulive.member.etc.exception;
...
// 컨트롤러는 패키지에 등록하니 
@ControllerAdvice(basePackages={"org.zerock.seoulive.member.etc.controller"}) // For one package
public class EtcControllerExceptionHandler {
